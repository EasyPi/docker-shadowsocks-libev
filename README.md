...
```bash
# download package
wget https://github.com/EasyPi/docker-shadowsocks-libev/releases/download/v2.5.2/shadowsocks-libev_2.5.2-1_amd64.deb
# install package
dpkg -i shadowsocks-libev_2.5.2-1_amd64.deb
# fix broken
apt-get -f install -y
# edit config
